...
No obstante, en los momentos en los que no tengo respuesta para sus preguntas, como, por ejemplo, cuando me inquiere qué sentido tiene el apelativo _negro_ en la variante mexicana (00:32:46) o a qué se refiere una canción sobre la leyenda de [_la Llorona_](https://es.wikipedia.org/wiki/Llorona), lo que hago es **realizar búsquedas en internet** y **facilitarle enlaces** como este ([haz clic aquí](https://leyendadeterror.com/la-leyenda-de-la-llorona/)), que le voy parafraseando al mismo tiempo  –este último hecho no fue grabado–.
