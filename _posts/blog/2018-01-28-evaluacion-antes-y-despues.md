...
Así pues, a la hora de la verdad, ¿cómo llevar a cabo una evaluación coherente con los objetivos didácticos que han determinado el desarrollo de nuestras clases? ¿De qué sirve abogar por el trabajo de destrezas contextualizadas si después implementamos una prueba plagada de rellena huecos y otras prácticas de precisión? Hoy quiero revisar con vosotros la naturaleza de esta actividad tan crucial para completar el ciclo de cualquier labor docente y, no obstante, olvidada demasiado a menudo por los teóricos del enfoque comunicativo.
